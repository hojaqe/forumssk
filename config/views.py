...
from .permission import IsActivePermissions
from .serializers import RegistrationSerializers, ActivationSerializer, LoginSerializers, ChangePasswordSerializer, ForgotPasswordSerializer, ForgotPasswordCompleteSerializer
